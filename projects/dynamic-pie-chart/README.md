...
selected | OUT |  an eventEmitter to inform the parent component that a slice has been activated
activated | OUT |  an eventEmitter to inform the parent component that a slice has been selected
